...
namespace Masrofy.DAL.Migrations
{
    ...
    [Migration("20250630094606_IdentityUserMigr")]
    partial class IdentityUserMigr
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masrofy.DAL.Extends.ApplicationUsers", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Masrofy.DAL.Extends.ApplicationUsers", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
